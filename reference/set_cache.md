...
[`disable_cache`](https://cmu-delphi.github.io/epidatr/reference/disable_cache.md)
...
#>   intended).
#> ℹ The cache directory is /tmp/Rtmpw8rt3Y.
#> ℹ The cache will be cleared after 14 days and will be pruned if it exceeds 512
#>   MB.
#> ℹ The log of cache transactions is stored at /tmp/Rtmpw8rt3Y/logs.txt.
```
