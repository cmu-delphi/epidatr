...
#'
#' @param auth character restricted access key (not the same as API key)
...
#' @param issues optionally specify the exact issues to fetch
#' @param lag optionally specify the issue lag
#' @param auth optional restricted access key (not the same as the API key)
#' @return an instance of epidata_call
#'
#' @export
fluview <-
...
#' # fetch_classic(call)
#' @param auth restricted access key (not the same as the API key)
#' @param locations locations to fetch
#' @param epiweeks epiweeks to fetch
#' @param query query
#' @return an instance of epidata_call
