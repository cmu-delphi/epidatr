test_that("basic_epidata_call", {
  ...
  expect_no_error(covidcast(data_source = "jhu-csse", signals = "confirmed_7dav_incidence_prop", time_type = "day", geo_type = "state", time_values = epirange(20200601, 20200801), geo_values = "ca,fl"))
  ...
  expect_no_error(pvt_quidel(auth = "yourkey", epiweeks = epirange(201201, 202001), locations = "hhs1"))
  ...
  expect_no_error(covidcast(data_source = "jhu-csse", signals = "confirmed_7dav_incidence_prop", time_type = "day", geo_type = "state", time_values = epirange(20200601, 20200801), geo_values = "ca,fl") %>% request_url())
  ...
  expect_no_error(pvt_quidel(auth = "yourkey", epiweeks = epirange(201201, 202001), locations = "hhs1") %>% request_url())
