...
| `stderr`, `sample_size` | dropped | Some sources publish their own uncertainty columns instead; see below. |
...
adds its own columns, such as `ci_lower` and `ci_upper`. Use the metadata to
see which value columns a source returns:
