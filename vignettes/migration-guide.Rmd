...
endpoints. While `pub_covidcast()` is the most widely used legacy endpoint, historical
V3 endpoints differ in their function names and parameter conventions. The tables
