...
For sources on the modern V5 API (queried with `epidata_snapshot()` and `epidata_archive()`), `epidata_meta()` is the primary metadata lookup.
...
<details id="available-endpoints">
<summary>View all historical package endpoints</summary>
