...
If the above does not open a browser, you can try using a Python server
...
document](https://cmu-delphi.github.io/epidatr/dev/pull_request_template.md).
...
results](https://cran.rstudio.org/web/checks/check_results_epidatr.html).
