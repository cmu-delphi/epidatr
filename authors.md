...
- **Samuel Gratzl**. Author.

- **David Weber**. Contributor, maintainer.
...
Source:
[`inst/CITATION`](https://github.com/cmu-delphi/epidatr/blob/main/inst/CITATION)

Farrow DC, Brooks LC, Rumack A, Tibshirani RJ, Rosenfeld R (2015).
“Delphi Epidata API.” <https://github.com/cmu-delphi/delphi-epidata>.

    @Misc{,
      title = {Delphi Epidata API},
      author = {David C. Farrow and Logan C. Brooks and Aaron Rumack and Ryan J. Tibshirani and Roni Rosenfeld},
      year = {2015},
